...
(function (global) {
    ...
    function drawCalendarMonthTable(data, option) {
      var table, div, container, elem, prevnextcontainer;
      ...
      prevnextcontainer.setAttribute("class", "con-prev-next");
      ...
      if (option.prevnextbutton === "show") {
        ...
        elem.innerHTML = "&lt;";
        prevnextcontainer.appendChild(elem);
      }
      ...
      //add previous and next buttons to container
  
      div.appendChild(prevnextcontainer);
    ...
    function onClick() {
      document.body.onclick = function (e) {
        ...
        if (
          ...
          option = JSON.parse(
            targetDomObject.parentElement.parentElement.getAttribute(
              "data-option"
            )
          );
        ...
        if (
          targetDomObject &&
          targetDomObject.classList &&
          targetDomObject.classList.contains("dycalendar-date")
        ) {
          targetDomObject.parentElement.parentElement
            .querySelectorAll("tr td")
            .forEach((elem) => elem.classList.remove("active"));
  
          targetDomObject.classList.add("active");
  
          const date =
            targetDomObject.parentElement.parentElement.parentElement.parentElement.parentElement
              .querySelector(".dycalendar-span-month-year")
              .innerText.split(" ");
  
          const composeDate =
            date[0] + " " + targetDomObject.innerText + ", " + date[1];
          ...
          const dateResult = new Date(composeDate);
          function scheduleDate() {
          //   console.log(
          //     "value of date ==>",
          //     dateMap[dateResult.getDay()] + ", " + targetDomObject.innerText
          //   );
            return  dateMap[dateResult.getDay()] + ", " + targetDomObject.innerText
          }
          let scheduledate = (document.getElementById("schedule-date").textContent = scheduleDate());
